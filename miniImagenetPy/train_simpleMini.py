...
def run(args):
    ...
    val_dl = loadDL('val', n_episodes_test, n_way_test, k_spt + k_qry)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-episodes-test', type=int, default=400)
    parser.add_argument('--n-way', type=int, default=30)
    parser.add_argument('--n-way-test', type=int, default=5)
    parser.add_argument('--k-spt', type=int, default=1)
